...
public class InventoryBag implements IInventory {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.bag";
	}
	...
	public void writeToNBT(NBTTagCompound nbt) {
		nbt.setString("uniqueID", this.uniqueID);

		if (this.hasCustomName()) {
			NBTTagCompound name = new NBTTagCompound();
			name.setString("Name", this.getCustomName());
	...
	public void readFromNBT(NBTTagCompound nbt) {
		...
		if (nbt.hasKey("display", 10)) {
			this.setCustomName(nbt.getCompoundTag("display").getString("Name"));
		}
